...
public class GetInterAccountTransferResponseModel {
	...
	@JsonProperty(required=true,value="amountNumberTo")
	...
	public GetInterAccountTransferResponseModel(){
		
	}
	
	public GetInterAccountTransferResponseModel(double amountTransferred, Date dateOfTransfer, long accountNumberFrom,
	...
	public String toString() {
		return "GetInterAccountTransferResponseModel [amountTransferred=" + amountTransferred + ", dateOfTransfer="
